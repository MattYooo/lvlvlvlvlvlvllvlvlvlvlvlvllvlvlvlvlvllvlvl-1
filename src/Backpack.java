...
Backpack kase = new Backpack ();
Pencil tooth=new Pencil ();
Ruler Trump=new Ruler ();
Textbook memepage=new Textbook ();
kase.putInBackpack(tooth);
kase.putInBackpack(Trump);
kase.putInBackpack(memepage);
kase.goToSchool();
memepage.read();
tooth.write("I love memes");
Trump.measure();
	}
